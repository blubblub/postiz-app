    ...
    >
      ...
      {show && (
        ...
        >
          ...
          {/* Offered on every channel, not just broken ones: re-running OAuth is
              also how you widen a channel's granted scopes, and a channel whose
              permissions were narrowed elsewhere still reports refreshNeeded
              false until something hits the API and fails. */}
            ...
            >
              <div>
                <svg
                  ...
                  viewBox="0 0 32 32"
                  fill={
                    findIntegration?.refreshNeeded ? 'yellow' : 'currentColor'
                  }
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
